...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
      ...
      List<Cliente> listaClientes= newList<Cliente>();
      ...
      ViewBag.lista Clientes= lista Clientes;
      ...
      List<Fornecedor> listaFornecedores= newList<Fornecedor>();
      ...
      ViewBag.lista Fornecedores= lista Fornecedores;
